...
import com.delta.assembler.UserProfileResourceAssembler;
...
public class UserProfileController {
  ...
  @Autowired
  private UserProfileService golfClassService;
...
//  }
  ...
  public ResponseEntity<?> getAll() {
    try {
      List<UserProfile> golfClassList = golfClassService.findAll();
  ...
  public ResponseEntity<?> getAllByWeekDate(@ApiParam(value = "Week Date") @PathVariable String weekDate,
    ...
    try {
      List<UserProfile> golfClassList = golfClassService.findByWeekDateAndAdditional(weekDate, additional);
      return ResponseEntity.ok(new Resources<>(assembler.toResources(golfClassList)));
    } catch (Exception e) {
      return ResponseEntity.badRequest().body(new Resource<>(e.toString()));
    }
  ...
  public ResponseEntity<?> update(@RequestBody List<String> uuids,
    ...
    try {
      ...
      uuids.forEach(uuid -> {
        ...
        String weekDate = "";
        UserProfile golfClass = golfClassService.findByUuid(uuid);
